...
public class SecurityApplicationTests {
    ...
    private static final Logger log = LoggerFactory.getLogger(SecurityApplicationTests.class);
    ...
    /**  
     * @Description: <pre>multiRealm默认情况
     * securityManager.authenticator=ModularRealmAuthenticator
     * securityManager.authenticator.authenticationStrategy=AtLeastOneSuccessfulStrategy</pre>
     * @author yanlei
